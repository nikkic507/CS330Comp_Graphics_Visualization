...
void SceneManager::DefineObjectMaterials()
{
	...
	goldMaterial.specularColor = glm::vec3(0.7f, 0.7f, 0.7f);
...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("directionalLight.direction", -0.5f, -0.3f, -0.1f);
...
void SceneManager::RenderScene()
{
	...
	SetShaderColor(0.289f, 0.4012f, 0.85f, 1.0f);//changed to blue
